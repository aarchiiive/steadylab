...
static const _ReadCar_type_support_symbol_names_t _ReadCar_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serial_communication, msg, ReadCar)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serial_communication, msg, ReadCar)),
  }
};
...
{
  return &::serial_communication::msg::rosidl_typesupport_cpp::ReadCar_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, serial_communication, msg, ReadCar)() {
  return get_message_type_support_handle<serial_communication::msg::ReadCar>();
}
